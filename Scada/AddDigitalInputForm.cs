...
namespace Scada
{
    public partial class AddDigitalInputForm : Form
    {
        ...
        public AddDigitalInputForm(DataConcentratorManager dm)
        {
            result = null;
        ...
        private void btnOK_Click(object sender, EventArgs e)
        {
            ...
            if (Int32.TryParse(textBoxScanTime.Text, out time))
            {
                ...
                {
                    result = new DigitalInput(textBoxId.Text, textBoxDescription.Text,
                        comboBoxAddress.SelectedItem.ToString(), time);
